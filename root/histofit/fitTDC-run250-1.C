...
Double_t offset=0;
  ...
  TH1F *hmod2;  
  TH1F *htimeInteg;
  TPaveText *pt250 = new TPaveText(0.55,0.25,0.85,0.4, "NDC");
...
int fit250() {
  ...
  pt250->AddText("run250 - source inside nero (holder)");
  pt250->AddText("one paddle covers end of beamline hole");
