...
int initwushapers()
{
   ...
   i=0;
   fp=fopen("shaper_init_03034.dat","r");
 ...
 *
 * Functional description:
 * Reads characters from a file pointed to by *fp until it encounters 
 * a newline character returns the charters read in line.
 * 
 * note it attaches a '\0' (end of line) after the '\n'
 */
